            ...
            <div class="p-4 ">
              <div class="block sm:flex sm:justify-between">
                ...
                <div class="flex sm:justify-end">
                    ...
                    @endif
                    @if(in_array("phosphorous.find", $permissions))
                    <a href="https://cheddar-bicycle-878.notion.site/Manual-de-Uso-LectureLAB-b0b7d7cc54a4452d8fc45e3c1351e12f" target="_blank" class="focus:ring-blue-500 focus:border-blue-500 block ml-2 py-0.5 sm:mx-0 sm:mr-2  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-pointer mt-2">  
